...
import { useAiUsers } from "@/hooks/use-admin"
import {
    Table,
    TableHeader,
    TableBody,
...
export default function AiUsersPage() {
    const { aiUsers, loading, error } = useAiUsers()
    ...
    return (
        <Card className="p-6">
            <h2 className="text-2xl font-semibold mb-4">AI Feature Users</h2>
            <Table>
                <TableHeader>
                    <TableRow>
                        <TableHead>User Email</TableHead>
